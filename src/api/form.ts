...
export default class Request {
  ...
  // 导出表格数据
  static exportExcel (params: object) {
    return $axios
  ...
  // 获取详情
  static getDetail (pd_id:  number|string, triage_id:  number|string, hospital_id:  number|string, template_id: number|string) {
    return $axios
      .get(
        formUrl +
